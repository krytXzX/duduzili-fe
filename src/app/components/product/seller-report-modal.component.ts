        ...
        >
          ...
          @if (step() === 2) {
            <button
              ...
              class="absolute left-4 top-[26px] flex h-8 w-10 items-center justify-center rounded-[10px] text-[#434455] transition hover:bg-[#F7F7F8] active:scale-95 duration-200 md:left-4 md:top-[26px] disabled:opacity-50 disabled:pointer-events-none"
              aria-label="Go back"
            >
          ...
          <button
            ...
            (click)="closed.emit()"
            [disabled]="isSubmitting()"
            class="absolute right-4 top-4 flex h-11 w-11 items-center justify-center rounded-full border border-[#EAEAEA] bg-white text-[#434455] shadow-[0_4px_8px_rgba(202,202,202,0.25)] transition hover:bg-[#FAFAFA] active:scale-95 duration-200 md:right-5 md:top-5 disabled:opacity-50 disabled:pointer-events-none"
          ...
          @if (step() === 1) {
            <div class="mx-auto mt-10 flex w-full max-w-[334px] flex-col gap-[44px] md:mt-[65px]">
              ...
              <div class="space-y-0.5">
                @for (reason of reasons(); track reason) {
                  <button
                    ...
                    class="flex min-h-[44px] w-full items-center justify-between gap-4 border-b border-[#ECECEC] py-[10px] text-left transition hover:bg-[#FCFCFD]/80 active:scale-[0.99] duration-200"
              ...
              <button
                type="button"
                (click)="advanced.emit()"
                class="flex h-[52px] w-full items-center justify-center rounded-[64px] border border-white bg-[#6453D9] px-5 text-[16px] font-medium leading-6 text-white shadow-[0_4px_8px_rgba(81,35,173,0.4),0_0_0_1px_#2A6CE8] transition hover:bg-[#5645cb] active:scale-95 duration-200 disabled:cursor-not-allowed disabled:opacity-50"
