...
export class AuthLayoutComponent {
  ...
  // Watch router events to make the current URL reactive
  ...
  // Determine if we are on pages that should show the "Don't have an account" prompt
  ...
  protected readonly iconLogoUrl = 'assets/images/Vector.svg';
