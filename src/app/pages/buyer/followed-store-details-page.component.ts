...
@Component({
  ...
  imports: [CommonModule, RouterLink, ListingCardComponent, NgIcon],
  providers: [
    provideIcons({
      heroChevronRight,
      heroMapPin,
              ...
              <div class="relative">
                ...
                @if (showContactMenu()) {
                  ...
                  >
                    ...
                    >
                      <ng-icon name="heroChatBubbleOvalLeftEllipsis" class="text-[18px] text-[#6B7280]"></ng-icon>
                      Message in-app
                    </button>
                    <button
                      type="button"
                      ...
                      class="flex w-full items-center gap-3 rounded-[18px] px-4 py-3 text-left text-sm font-medium text-[#1A1C21] transition hover:bg-[#F7F7FA]"
                    >
                      <span class="flex h-[18px] w-[18px] items-center justify-center text-[#6B7280]">⌾</span>
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/35 p-4 backdrop-blur-sm">
          ...
          >
            ...
            <div class="grid gap-8 md:grid-cols-[260px_minmax(0,1fr)] md:gap-10">
              <div class="border-b border-[#EEF0F4] pb-6 md:border-b-0 md:border-r md:pb-0 md:pr-10">
                ...
                <div class="mt-8 overflow-hidden rounded-[28px] border border-[#EEF0F4] bg-white">
                  ...
                  <div class="relative px-5 pb-5 pt-10">
                    <div class="absolute -top-8 left-5 h-16 w-16 overflow-hidden rounded-full border-4 border-white bg-white shadow-sm">
                      <img [src]="store().logo" [alt]="store().name" class="h-full w-full object-cover" />
                    </div>
                    ...
                    <h3 class="flex items-center gap-1 text-[16px] font-medium text-[#1A1C21]">
                      {{ store().name }}
                      @if (store().isVerified) {
                        <ng-icon name="heroCheckBadge" class="text-[16px] text-[#5932EA]"></ng-icon>
                      }
                    </h3>
              ...
              <div>
                ...
                <div class="mt-10">
                  <h3 class="text-[18px] font-semibold text-[#1A1C21]">
                    Attach some pictures <span class="font-normal text-[#6B7280]">(optional)</span>
                  </h3>

                  <div class="mt-5 rounded-[24px] border border-dashed border-[#D6DAE4] bg-[#FCFCFD] p-6">
                    <input
                      #reviewImageInput
                      type="file"
                      multiple
  ...
  readonly productSections = signal<ProductSection[]>([
    {
      ...
      countLabel: '3,341',
      items: [
        this.createListing('iphone-17', 'Iphone 17 pro max', '₦2,500,000', '/assets/images/image-1-1.jpg', 'Phones & Laptops'),
        this.createListing('mouse-1', 'Logitech ergonomic mouse', '₦35,000', '/assets/images/image-2-1.jpg', 'Phones & Laptops'),
        this.createListing('keyboard-1', 'RGB keyboard', '₦35,000', '/assets/images/product_keyboard_rgb.png', 'Phones & Laptops'),
        this.createListing('iphone-x', 'Iphone X (64 gig)', '₦35,000', '/assets/images/image-3-1.jpg', 'Phones & Laptops'),
        this.createListing('chair-1', 'Ergonomic chair', '₦35,000', '/assets/images/image-4-1.jpg', 'Phones & Laptops'),
      ],
    },
    {
      id: 'men',
      ...
      countLabel: '3,341',
      items: [
        this.createListing('tie-1', 'Tie', '₦35,000', '/assets/images/fashion_menswear_hero.png', 'Men'),
        this.createListing('car-1', 'Masarati', '₦35,000', '/assets/images/product_watch_luxury.png', 'Men'),
        this.createListing('sneaker-1', 'Nike sneaker', '₦35,000', '/assets/images/product_sneakers_lifestyle.png', 'Men'),
        this.createListing('perfume-1', 'Dior sauvage', '₦35,000', '/assets/images/product_perfume.png', 'Men'),
        this.createListing('watch-1', 'G-shock wrist watch', '₦35,000', '/assets/images/product_watch_luxury.png', 'Men'),
      ],
    },
    {
      id: 'women',
      ...
      countLabel: '3,341',
      items: [
        this.createListing('sneaker-2', 'Nike sneaker', '₦35,000', '/assets/images/product_sneakers_lifestyle.png', 'Women'),
        this.createListing('wig-1', 'Bone straight wig', '₦35,000', '/assets/images/image-4-1.jpg', 'Women'),
        this.createListing('chair-2', 'Ergonomic chair', '₦35,000', '/assets/images/image-2-1.jpg', 'Women'),
        this.createListing('plate-1', 'Kitchen utensils', '₦35,000', '/assets/images/image-3-1.jpg', 'Women'),
        this.createListing('hoodie-1', 'Sweatshirt', '₦35,000', '/assets/images/fashion_menswear.png', 'Women'),
      ],
    },
    {
      id: 'beauty',
      ...
      countLabel: '3,341',
      items: [
        this.createListing('perfume-2', 'Luxury perfume set', '₦35,000', '/assets/images/product_perfume.png', 'Beauty'),
        this.createListing('wig-2', 'Bone straight wig', '₦35,000', '/assets/images/image-4-1.jpg', 'Beauty'),
        this.createListing('plate-2', 'Skin care collection', '₦35,000', '/assets/images/image-3-1.jpg', 'Beauty'),
        this.createListing('hoodie-2', 'Beauty essentials', '₦35,000', '/assets/images/fashion_menswear.png', 'Beauty'),
        this.createListing('chair-3', 'Salon chair', '₦35,000', '/assets/images/image-2-1.jpg', 'Beauty'),
      ],
    },
  ]);
