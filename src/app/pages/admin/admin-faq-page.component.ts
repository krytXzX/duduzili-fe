                      ...
                      @if (openMenuIndex() === index) {
                        ...
                        >
                          ...
                          <div class="space-y-1">
                            ...
                            >
                              <img src="/assets/icons/edit-2.svg" alt="Edit" class="h-4 w-4" />
                              Edit
                            </button>
                            ...
                            @if (item.status === 'Published') {
                              <button
                                ...
                                class="flex w-full items-center gap-2.5 rounded-lg px-2.5 py-2 text-[13px] font-semibold text-[#1F1F1F] hover:bg-gray-50 transition"
                              >
                                <img src="/assets/icons/pause.svg" alt="Archive" class="h-4 w-4" />
                                Archive
                              </button>
                            }
                            ...
                            @if (item.status === 'Archived') {
                              <button
                                ...
                                class="flex w-full items-center gap-2.5 rounded-lg px-2.5 py-2 text-[13px] font-semibold text-[#1F1F1F] hover:bg-gray-50 transition"
                              >
                                <img src="/assets/icons/play.svg" alt="Publish" class="h-4 w-4" />
                                Publish
                              </button>
                            }
          ...
          @if (openMenuIndex() === index) {
            ...
            >
              ...
              <div class="space-y-2">
                ...
                >
                  <img src="/assets/icons/trash.svg" alt="Delete" class="h-4 w-4 text-[#FF3B30]" />
                  Delete
                </button>
              </div>
            </div>
