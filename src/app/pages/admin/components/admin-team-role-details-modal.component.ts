  ...
  template: `
    ...
    >
      <div
        ...
        class="max-h-[85vh] w-full overflow-y-auto rounded-t-[32px] rounded-b-[32px] bg-white p-6 shadow-[0_30px_80px_-40px_rgba(19,27,45,0.45)] sm:max-h-[calc(100vh-2rem)] sm:max-w-[760px] sm:rounded-[26px] sm:p-8"
