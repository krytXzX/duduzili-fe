      ...
      >
        ...
        <div class="mt-14 flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:justify-end">
          ...
          <button
            type="button"
            (click)="confirm.emit()"
            class="w-full rounded-full bg-[#6653e4] px-6 py-3 text-[15px] font-medium text-white shadow-[0_16px_32px_-18px_rgba(102,83,228,0.9)] transition hover:bg-[#5945db] sm:min-w-[142px] sm:w-auto"
          >
            Yes, activate
          </button>
        </div>
