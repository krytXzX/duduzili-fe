  ...
  template: `
    ...
    >
      <div
        ...
        class="w-full max-w-[600px] rounded-[10px] bg-white px-6 py-12 text-center shadow-[0_30px_80px_-40px_rgba(19,27,45,0.45)] sm:px-10 sm:py-16"
        (click)="$event.stopPropagation()"
      >
        <div class="mx-auto flex w-full max-w-[395px] flex-col items-center gap-6">
          ...
          <div class="flex w-full flex-col items-center gap-8">
            ...
            <div class="flex items-center gap-2">
              <button
                ...
                class="h-11 rounded-[82px] bg-[#F5F5F5] px-6 text-[16px] font-medium tracking-[-0.5px] text-[#05061A] transition hover:bg-[#ededed]"
              >
                Add another user
              </button>
              ...
              <button
                type="button"
                (click)="done.emit()"
                class="h-10 rounded-full border border-white bg-[#6453D9] px-5 text-[14px] font-medium text-white shadow-[0_4px_12px_rgba(81,35,173,0.33),0_0_0_1px_#6B5BD5] transition hover:bg-[#5C4AD0]"
              >
                Done
              </button>
            </div>
