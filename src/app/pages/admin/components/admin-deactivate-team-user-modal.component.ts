      ...
      >
        ...
        <div class="mt-14 flex flex-wrap justify-end gap-3">
          ...
          <button
            type="button"
            (click)="confirm.emit()"
            class="min-w-[156px] rounded-full bg-[#ff2d2d] px-6 py-3 text-[15px] font-medium text-white shadow-[0_16px_32px_-18px_rgba(255,45,45,0.9)] transition hover:bg-[#f32020]"
          >
            Yes, deactivate
          </button>
        </div>
