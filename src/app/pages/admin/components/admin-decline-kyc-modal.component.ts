...
export interface DeclineKycPayload {
  requestId: string;
  reason: string;
}

@Component({
  selector: 'app-admin-decline-kyc-modal',
  imports: [NgIcon],
  ...
  template: `
    ...
    >
      <div
        role="dialog"
        aria-modal="true"
        aria-labelledby="decline-kyc-modal-title"
      ...
      >
        <div class="flex items-start justify-between gap-4">
          ...
          <button
            ...
            aria-label="Close decline KYC modal"
          >
        ...
        <div class="mt-4">
          <h2 id="decline-kyc-modal-title" class="text-[18px] font-semibold text-[#202020] sm:text-[20px]">
            Decline KYC request
          </h2>
        ...
        <div class="mt-7">
          <label for="decline-kyc-reason" class="mb-3 block text-[15px] font-medium text-[#4a4a4a]">
            Reason
          </label>

          <textarea
            id="decline-kyc-reason"
            [value]="reason()"
...
export class AdminDeclineKycModalComponent {
  readonly requestId = input.required<string>();

  readonly close = output<void>();
  readonly confirm = output<DeclineKycPayload>();
