...
import { heroTrash, heroXMark } from '@ng-icons/heroicons/outline';

@Component({
  selector: 'app-admin-delete-team-user-modal',
  imports: [NgIcon],
  ...
  template: `
    ...
    >
      ...
      >
        ...
        <div class="flex items-start justify-between gap-4">
          <div class="flex h-24 w-24 items-center justify-center rounded-full bg-[#fff3f3]">
            <div class="flex h-16 w-16 items-center justify-center rounded-full bg-[#ffdada] text-[#ff2d2d]">
              <ng-icon name="heroTrash" class="text-[34px]"></ng-icon>
            </div>
          </div>
        ...
        <div class="mt-4">
          <h2 id="delete-team-user-modal-title" class="text-[18px] font-semibold text-[#202020] sm:text-[20px]">
            Delete user
          </h2>
...
export class AdminDeleteTeamUserModalComponent {
