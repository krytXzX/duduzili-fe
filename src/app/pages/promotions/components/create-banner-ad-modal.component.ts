          ...
          <div class="flex h-full flex-col items-center justify-center px-6 py-10 text-center animate-in fade-in zoom-in-95 duration-300">
            ...
            <div class="mt-8 flex flex-wrap items-center justify-center gap-3">
              <button
                type="button"
                (click)="resetFlow()"
                class="rounded-full bg-[#F3F3F5] px-6 py-3.5 text-sm font-semibold text-[#353A43] transition hover:bg-[#E9EAF0] focus:outline-none focus:ring-4 focus:ring-gray-200"
              >
                Create another Ad
              </button>
              <button
                ...
                class="rounded-full bg-[#6653E4] px-6 py-3.5 text-sm font-semibold text-white shadow-[0_16px_32px_-18px_rgba(102,83,228,0.9)] transition hover:bg-[#5945DB] focus:outline-none focus:ring-4 focus:ring-[#6653E4]/20"
              >
                View running Ads
              </button>
            </div>
...
export class CreateBannerAdModalComponent {
  ...
  readonly boostingPlans: BoostingPlan[] = [
    ...
    { id: '30-days', label: 'Promote for 30 days', price: '₦1,000', unit: 'month', billing: 'Billed monthly', savings: '50%' },
  ];
  ...
  readonly selectedPlanId = signal('7-days');
