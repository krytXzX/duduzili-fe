...
@Component({
  ...
  template: `
    <div
      class="fixed inset-0 z-[220] flex bg-black/20 p-4 backdrop-blur-[2px] animate-in fade-in duration-300"
      (click)="close.emit()"
    >
      <div
                      ...
                      <div class="flex items-start gap-3">
                        ...
                        <div>
                          <div class="flex items-center gap-3">
                            ...
                            @if (option.savings) {
                              <span class="rounded-full bg-[#F1F7AA] px-2 py-0.5 text-xs font-semibold text-[#6A7414]">
                                Save {{ option.savings }}
                              </span>
                            }
                          </div>
...
export class AdsSubscriptionModalComponent {
